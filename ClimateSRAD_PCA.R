...
important_traits <- c("srad.ann.mean","srad.ann.sd","srad.ann.max","srad.ann.min",
...
malus_climate_srad <- malus_climate_srad[complete.cases(malus_climate_srad[,important_traits]),]
#Reduction of Malus Variables: saved them to hard drive
MalusSRAD_Reduction1 <- cor(malus_climate_srad[,important_traits])
...
#Malus PCA 1
malus.pca <- prcomp(malus_climate_srad[,important_traits], center = TRUE,scale. = TRUE) 
summary(malus.pca)
malus.pca$rotation
...
quercus_climate_srad <- quercus_climate_srad[complete.cases(quercus_climate_srad[,important_traits]),]
#Reduction of Quercus Variables: saved them to hard drive
QuercusSRAD_Reduction1 <- cor(quercus_climate_srad[,important_traits])
...
#Quercus PCA 1
quercus.pca <- prcomp(quercus_climate_srad[,important_traits], center = TRUE,scale. = TRUE) 
summary(quercus.pca)
...
tilia_climate_srad <- tilia_climate_srad[complete.cases(tilia_climate_srad[,important_traits]),]
#Reduction of tilia Variables: saved them to hard drive
TiliaSRAD_Reduction1 <- cor(tilia_climate_srad[,important_traits])
...
#tilia PCA 1
tilia.pca <- prcomp(tilia_climate_srad[,important_traits], center = TRUE,scale. = TRUE) 
summary(tilia.pca)
tilia.pca$rotation
#analysis of PCA Plots
...
ulmus_climate_srad <- ulmus_climate_srad[complete.cases(ulmus_climate_srad[,important_traits]),]
#Reduction of Ulmus Variables: saved them to hard drive
UlmusSRAD_Reduction1 <- cor(ulmus_climate_srad[,important_traits])
...
#Ulmus PCA 1
ulmus.pca <- prcomp(ulmus_climate_srad[,important_traits], center = TRUE,scale. = TRUE) 
summary(ulmus.pca)
ulmus.pca$rotation
#analysis of PCA Plots
