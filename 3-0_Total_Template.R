...
write.csv(MalusTotal_Reduction, paste0("D:/Data_IMLS_Ecological_Value/Total_PreReductions2/MalusTotal_Reduction.csv"), row.names=FALSE)
...
write.csv(Malus_Climate_Final, "D:/Data_IMLS_Ecological_Value/Total_PostReductions2/Malus_Climate_Final.csv", row.names=FALSE)
...
write.csv(QuercusTotal_Reduction, paste0("D:/Data_IMLS_Ecological_Value/Total_PreReductions2/QuercusTotal_Reduction.csv"), row.names=FALSE)
...
write.csv(Quercus_Climate_Final, "D:/Data_IMLS_Ecological_Value/Total_PostReductions2/Quercus_Climate_Final.csv", row.names=FALSE)
...
write.csv(TiliaTotal_Reduction, paste0("D:/Data_IMLS_Ecological_Value/Total_PreReductions2/TiliaTotal_Reduction.csv"), row.names=FALSE)
...
write.csv(Tilia_Climate_Final, "D:/Data_IMLS_Ecological_Value/Total_PostReductions2/Tilia_Climate_Final.csv", row.names=FALSE)
...
write.csv(UlmusTotal_Reduction, paste0("D:/Data_IMLS_Ecological_Value/Total_PreReductions2/UlmusTotal_Reduction.csv"), row.names=FALSE)
